...
extern uint64_t L3_access ;
extern uint64_t L3_read_miss ;
extern uint64_t L3_write_miss ;
extern uint64_t L3_write_back ;
...
void setup_cache(uint64_t c1, uint64_t b1, uint64_t s1, uint64_t v,
                 uint64_t c2, uint64_t b2, uint64_t s2, uint64_t c3, uint64_t b3, uint64_t s3);
...
static const uint64_t DEFAULT_C3 = 15;  /* 4KB Cache 3;//*/
static const uint64_t DEFAULT_B3 = 5;    /* 32-byte blocks 1;//*/
static const uint64_t DEFAULT_S3 = 4;   /* 8 blocks per set 3;//*/
